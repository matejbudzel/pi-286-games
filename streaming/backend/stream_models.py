...
# Filters are applied after DOSBox's fixed normal/normal2x output and before
# tile-delta detection, so clients can request presentation without changing
# the source geometry.
VIDEO_FILTERS = ("none", "crt-lite")
