...
dosbox_x_patch_files="$dosbox_x_repo/patches/dosbox-x/0001-disable-libpng-when-screenshots-are-disabled.patch $dosbox_x_repo/patches/dosbox-x/0002-cross-armhf-host-is-armv6.patch"
