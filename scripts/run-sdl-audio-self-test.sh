...
echo "Playing a two-second SDL 1.2 square-wave tone through hw:0,0."
exec env LD_LIBRARY_PATH="$prefix/lib${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}" SDL_AUDIODRIVER=alsa AUDIODEV=hw:0,0 SDL_PATH_DSP=hw:0,0 "$binary"
