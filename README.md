...
SDL's ALSA backend and `AUDIODEV=hw:HDMI,0`, matching the verified HDMI device
without relying on its numeric card order. Log out and back in after the new
group membership, or reboot after installation.
